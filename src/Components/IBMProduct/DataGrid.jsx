...
const DatagridActions = (datagridState) => {
  ...
  useEffect(() => {
    const button = document.getElementsByClassName('c4p--datagrid-filter-flyout__trigger')[0];
    const handler = () => {
      button.classList.contains('c4p--datagrid-filter-flyout__trigger--open') ? closeModal() : openModal();
      console.log(button.classList.contains('c4p--datagrid-filter-flyout__trigger--open'))
    }
